...
```
crpi-xjld0ipmc9tve2uz.cn-chengdu.personal.cr.aliyuncs.com/xiaoliu_111/litevpn-client-linux:v1.0
```
...
docker build --provenance=false --sbom=false \
  ...
  -t crpi-xjld0ipmc9tve2uz.cn-chengdu.personal.cr.aliyuncs.com/xiaoliu_111/litevpn-client-linux:v1.0 .
docker push crpi-xjld0ipmc9tve2uz.cn-chengdu.personal.cr.aliyuncs.com/xiaoliu_111/litevpn-client-linux:v1.0
```

其它环境拉取（需先 `docker login` 该仓库）：

```bash
docker pull crpi-xjld0ipmc9tve2uz.cn-chengdu.personal.cr.aliyuncs.com/xiaoliu_111/litevpn-client-linux:v1.0
```
